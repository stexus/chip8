...
fn decode(raw_inst: u8) -> Result<Instruction, Exception> {
    ...
    match &nibbles[3] {
        ...
        1 => Ok(Instruction::new(Operation::JP, &nibbles)),
        2 => Instruction::new(Operation::CALL, &nibbles),
        3 => Instruction::new(Operation::SEI, &nibbles),
        4 => Instruction::new(Operation::SNEI, &nibbles),
        5 => Instruction::new(Operation::SE, &nibbles),
        6 => Instruction::new(Operation::LI, &nibbles),
        7 => Instruction::new(Operation::ADDI, &nibbles),
        //arithmetic instructions
        8 => todo!(),
        9 => Instruction::new(Operation::SNE, &nibbles),
        0xA => Instruction::new(Operation::LA, &nibbles),
        0xB => Instruction::new(Operation::JRO, &nibbles),
        0xC => todo!(),
        0xD => todo!(),
        0xE => todo!(),
        0xF => todo!(),
